...
# Test the start of the transfer
...
# Test selecting the source account
@pytest.mark.asyncio(loop_scope="session")
...
# Test entering the transfer amount
@pytest.mark.asyncio(loop_scope="session")
...
# Test sending the confirmed transfer
@pytest.mark.asyncio(loop_scope="session")
